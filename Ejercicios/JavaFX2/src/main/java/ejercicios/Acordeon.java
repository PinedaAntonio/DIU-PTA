...
public class Acordeon extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image logo1 = new Image("file:resources/imagenes/ronaldo.gif", 100, 100, true, true);
            Image logo2 = new Image("file:resources/imagenes/polishcow.gif", 100, 100, true, true);
