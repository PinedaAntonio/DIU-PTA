...
public class Paginacion extends Application {
    ...
    private VBox creaPagina(int indice) {
        ...
        if (indice == 0) {
            Image logo = new Image("file:resources/imagenes/polishcow.gif", 100, 100, true, true);
            raizPagina.getChildren().add(new ImageView(logo));
            return raizPagina;
        } else if (indice == 1) {
            Image logo = new Image("file:resources/imagenes/ronaldo.gif", 100, 100, true, true);
            raizPagina.getChildren().add(new ImageView(logo));
            return raizPagina;
        } else
            return null;
