...
public class Botones extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imagen = new Image("file:resources/imagenes/polishcow.gif", 100, 100, true, true);
            ...
            Image imagen2 = new Image("file:resources/imagenes/moai.jpeg", 100, 100, true, true);
